...
'''
Búsqueda del directorio adecuado con las imágenes de OCT, iPhone y Samsung distribuidas en las cajas de validación cruzada en función de si las queremos con preprocesamiento gaussiano o no.
